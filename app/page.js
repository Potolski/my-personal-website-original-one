    ...
    <div className={`min-h-screen ${bgClass} ${textClass}`}>
      ...
      <nav className={`${navBgClass} p-4 sticky top-0 z-10 shadow-lg`}>
        <div className="container mx-auto flex justify-between items-center">
          ...
          <div className="flex space-x-4 items-center">
            <a href="#about" className={`hover:${accentTextClass} transition-colors`}>
              About
            </a>
            <a
              href="#experience"
            ...
            <a href="#skills" className={`hover:${accentTextClass} transition-colors`}>
              Skills
            </a>
            <button 
              onClick={toggleTheme} 
      ...
      >
        ...
        <p className={`text-xl mb-8 ${darkMode ? 'text-gray-300' : 'text-gray-700'} max-w-3xl`}>
          ...
          <span className={`block mt-2 text-sm ${darkMode ? 'text-gray-400' : 'text-gray-500'}`}>— Steve Jobs</span>
        </p>
        ...
        <div className="flex flex-wrap justify-center gap-4 mb-10">
          <a
            ...
            target="_blank"
            className={`flex items-center px-4 py-2 ${darkMode ? 'bg-gray-800 text-white' : 'bg-gray-200 text-gray-800'} hover:bg-gray-700 hover:text-white rounded-lg transition-colors`}
          >
      ...
      <section id="experience" className="container mx-auto px-4 py-16">
        ...
        <div className="mb-12 max-w-4xl mx-auto">
          <div className="flex justify-between items-start mb-2">
            ...
            <div className="text-gray-400">{darkMode ? 'Jan 2024 - Present' : 'Jan 2024 - Present'}</div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-5xl mx-auto">
          ...
          <div className={`${darkMode ? "bg-gray-800" : "bg-white"} p-6 rounded-xl shadow border ${borderClass}`}>
            ...
            <ul className="space-y-2">
              <li className="flex items-center">
                ...
                <span className={darkMode ? "" : "text-gray-700"}>Smart Contracts & Blockchain</span>
              </li>
              <li className="flex items-center">
                <i className="fas fa-check-circle text-green-500 mr-2"></i>
                <span className={darkMode ? "" : "text-gray-700"}>Distributed Systems</span>
              </li>
              <li className="flex items-center">
                <i className="fas fa-check-circle text-green-500 mr-2"></i>
                <span className={darkMode ? "" : "text-gray-700"}>Cryptography</span>
              </li>
              <li className="flex items-center">
                <i className="fas fa-check-circle text-green-500 mr-2"></i>
                <span className={darkMode ? "" : "text-gray-700"}>Systems Architecture</span>
              </li>
              <li className="flex items-center">
                <i className="fas fa-check-circle text-green-500 mr-2"></i>
                <span className={darkMode ? "" : "text-gray-700"}>Machine Learning & AI</span>
              </li>
              <li className="flex items-center">
                <i className="fas fa-check-circle text-green-500 mr-2"></i>
                <span className={darkMode ? "" : "text-gray-700"}>MicroServices</span>
              </li>
            </ul>
          </div>
          ...
          <div className={`${darkMode ? "bg-gray-800" : "bg-white"} p-6 rounded-xl shadow border ${borderClass}`}>
            ...
            <ul className="space-y-2">
              <li className="flex items-center">
                <i className="fas fa-check-circle text-green-500 mr-2"></i>
                <span className={darkMode ? "" : "text-gray-700"}>Go, Solidity, Rust</span>
              </li>
              <li className="flex items-center">
                <i className="fas fa-check-circle text-green-500 mr-2"></i>
                <span className={darkMode ? "" : "text-gray-700"}>Python, JavaScript, TypeScript</span>
              </li>
              <li className="flex items-center">
                <i className="fas fa-check-circle text-green-500 mr-2"></i>
                <span className={darkMode ? "" : "text-gray-700"}>C++, C, C#</span>
              </li>
              <li className="flex items-center">
                <i className="fas fa-check-circle text-green-500 mr-2"></i>
                <span className={darkMode ? "" : "text-gray-700"}>Node.js, Express, NestJS</span>
              </li>
              <li className="flex items-center">
                <i className="fas fa-check-circle text-green-500 mr-2"></i>
                <span className={darkMode ? "" : "text-gray-700"}>React, React Native, Next.js</span>
              </li>
              <li className="flex items-center">
                <i className="fas fa-check-circle text-green-500 mr-2"></i>
                <span className={darkMode ? "" : "text-gray-700"}>Hardhat, Foundry</span>
              </li>
            </ul>
          </div>
          ...
          <div className={`${darkMode ? "bg-gray-800" : "bg-white"} p-6 rounded-xl shadow border ${borderClass}`}>
            ...
            <ul className="space-y-2">
              <li className="flex items-center">
                <i className="fas fa-check-circle text-green-500 mr-2"></i>
                <span className={darkMode ? "" : "text-gray-700"}>Docker, Kubernetes</span>
              </li>
              <li className="flex items-center">
                <i className="fas fa-check-circle text-green-500 mr-2"></i>
                <span className={darkMode ? "" : "text-gray-700"}>Terraform, AWS, Google Cloud</span>
              </li>
              <li className="flex items-center">
                <i className="fas fa-check-circle text-green-500 mr-2"></i>
                <span className={darkMode ? "" : "text-gray-700"}>GitHub Actions, CI/CD</span>
              </li>
              <li className="flex items-center">
                <i className="fas fa-check-circle text-green-500 mr-2"></i>
                <span className={darkMode ? "" : "text-gray-700"}>PostgreSQL, MongoDB, Redis</span>
              </li>
              <li className="flex items-center">
                <i className="fas fa-check-circle text-green-500 mr-2"></i>
                <span className={darkMode ? "" : "text-gray-700"}>RabbitMQ, WebSockets</span>
              </li>
              <li className="flex items-center">
                <i className="fas fa-check-circle text-green-500 mr-2"></i>
                <span className={darkMode ? "" : "text-gray-700"}>Prometheus, Grafana</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 text-center">
          <div className="flex justify-center mb-6">
            <a
              href="https://github.com/claudiovb"
              target="_blank"
              className={`mx-2 ${darkMode ? 'text-gray-400 hover:text-white' : 'text-gray-500 hover:text-gray-700'} transition-colors`}
            >
